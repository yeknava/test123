 ...
 */
final class Version20181110182132 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE product_attribute_pivot (product_id INT NOT NULL, attribute_id INT NOT NULL) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE product_attribute_pivot ADD FOREIGN KEY (product_id) REFERENCES products(id)');
        $this->addSql('ALTER TABLE product_attribute_pivot ADD FOREIGN KEY (attribute_id) REFERENCES attributes(id)');
    }
